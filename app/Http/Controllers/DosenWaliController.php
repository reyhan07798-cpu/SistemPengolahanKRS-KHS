...
class DosenWaliController extends Controller
{
    public function index()
    {
        ...
        $view = request()->routeIs('pages.dosen.*') ? 'pages.dosen.beranda' : 'pages.dosen_wali.beranda';
        return view($view, compact('stats', 'mahasiswa'));
    }
    ...
    public function khs(Request $request)
    {
        ...
        $view = request()->routeIs('pages.dosen.*') ? 'pages.dosen.khs' : 'pages.dosen_wali.khs';
    ...
    /**
     * Update profil dosen (dipanggil dari route pages.dosen.profil.update)
     */
