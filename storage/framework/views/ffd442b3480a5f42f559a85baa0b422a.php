<?php $__env->startSection('title', 'Beranda Admin'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="nb-page-header">
        ...
        <div class="flex gap-3 flex-wrap">
            <a href="<?php echo e(route('pages.admin.mahasiswa.index')); ?>" class="nb-btn nb-btn-secondary">
                <span class="material-symbols-outlined" style="font-size:20px;">group</span>
                Kelola Mahasiswa
            </a>
            <a href="<?php echo e(route('pages.admin.matakuliah.index')); ?>" class="nb-btn nb-btn-primary">
    ...
    <div class="nb-bento" style="grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));">
        <div class="nb-stat nb-stat--info nb-stat--ribbon">
            ...
            <div class="nb-stat-value"><?php echo e($totalMahasiswa ?? 0); ?></div>
        </div>
        ...
        <div class="nb-stat nb-stat--primary nb-stat--ribbon">
            ...
            <div class="nb-stat-value"><?php echo e($totalDosen ?? 0); ?></div>
        </div>
        ...
        <div class="nb-stat nb-stat--warning nb-stat--ribbon">
            ...
            <div class="nb-stat-value"><?php echo e($totalMataKuliah ?? 0); ?></div>
        </div>
        ...
        <div class="nb-stat nb-stat--accent nb-stat--ribbon">
            ...
            <div class="nb-stat-value"><?php echo e(number_format($avgIpk ?? 0, 2)); ?></div>
        </div>
    </div>
...
<script>
    const mahasiswaData = <?php echo json_encode($mahasiswa, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SistemPengolahanKRS-KHS\resources\views/pages/admin/dashboard_admin.blade.php ENDPATH**/ ?>