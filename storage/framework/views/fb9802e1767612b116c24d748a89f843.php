...
<?php $__env->startSection('content'); ?>
    ...
    <div class="nb-bento mb-6" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
        ...
        <div class="nb-stat nb-stat--warning nb-stat--ribbon">
            <div class="flex items-center gap-3">
                <div class="nb-stat-icon">
                    <?php if($data['status_krs'] === 'Disetujui' || $data['status_krs'] === 'Menunggu'): ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <select id="filterTahun">
                    <?php $__currentLoopData = $data['all_semesters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($sem->tahun_ajaran); ?>" <?php echo e($sem->is_active ? 'selected' : ''); ?>>
                            <?php echo e($sem->tahun_ajaran); ?> <?php echo e($sem->is_active ? '(Aktif)' : ''); ?>
            ...
            <div>
                ...
                <select id="filterSemester">
                    <?php $__currentLoopData = $data['all_semesters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="Semester <?php echo e($sem->semester); ?> <?php echo e($sem->tahun_ajaran); ?>" <?php echo e($sem->is_active ? 'selected' : ''); ?>>
                            Semester <?php echo e($sem->semester); ?> <?php echo e($sem->is_active ? '(Aktif)' : ''); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SistemPengolahanKRS-KHS\resources\views/pages/mahasiswa/ambil-krs.blade.php ENDPATH**/ ?>