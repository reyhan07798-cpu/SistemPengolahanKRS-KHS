...
<?php $__env->startSection('page_title', 'Tahun Ajaran'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="modalOverlay" class="nb-modal-overlay hidden" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <div class="nb-modal" style="max-width: 28rem;" onclick="event.stopPropagation()">
            ...
            <form action="<?php echo e(route('pages.admin.tahunajaran.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="bg-surface-alt border-2 border-ink rounded-md p-4">
                            <label class="flex items-center justify-between cursor-pointer">
                                ...
                                <div class="relative">
                                    <input type="checkbox" name="status" value="Aktif" class="nb-no-style sr-only peer" <?php echo e(old('status') ? 'checked' : ''); ?>>
...
<script>
    const rawData = <?php echo json_encode($tahunAjaran, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SistemPengolahanKRS-KHS\resources\views/pages/admin/data_tahunajaran.blade.php ENDPATH**/ ?>