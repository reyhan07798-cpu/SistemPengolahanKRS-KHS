...
<body>
    ...
    <header class="sh-header" id="shHeader">
        <nav class="sh-nav">
            <a href="#beranda" class="sh-brand">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo SIPAKAR" class="sh-brand-logo">
            ...
            <div class="sh-links">
                ...
                <a href="<?php echo e(route('login')); ?>" class="sh-btn sh-btn-primary">
    ...
    <aside class="sh-drawer" id="shDrawer">
        ...
        <div class="sh-drawer-footer">
            <a href="<?php echo e(route('login')); ?>" class="sh-btn sh-btn-primary sh-btn-block">
                <i class="bi bi-box-arrow-in-right"></i>
                Masuk
            </a>
        </div>
        ...
        <div class="hero-x-content">
            ...
            <h1 class="hero-x-title" data-aos="fade-up" data-aos-delay="100">
                ...
                <span class="hero-x-pill" id="heroPill">
                    <img src="<?php echo e(asset('images/logo-dashboard.png')); ?>" alt="Logo" class="hero-x-pill-img active" data-i="0">
                    <img src="<?php echo e(asset('images/Logo-Polibatam.png')); ?>" alt="Logo Polibatam" class="hero-x-pill-img" data-i="2">
                </span>
        ...
        <div class="gh-inner">
            ...
            <div class="gh-carousel" id="ghCarousel">
                <div class="gh-track" id="ghTrack">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="if-card if-card--1" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="if-card if-card--2" data-aos="fade-up" data-aos-delay="200">
                        <div class="if-card-inner">
                            <div class="if-card-image">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="if-card if-card--3" data-aos="fade-up" data-aos-delay="300">
                        <div class="if-card-inner">
                            <div class="if-card-image">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="if-card if-card--4" data-aos="fade-up" data-aos-delay="400">
                        <div class="if-card-inner">
                            <div class="if-card-image">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="if-card if-card--5" data-aos="fade-up" data-aos-delay="500">
                        <div class="if-card-inner">
                            <div class="if-card-image">
    ...
    <section class="hs-section about-section" id="tentang">
        <div class="hs-content" data-aos="fade-right">
            ...
            <div class="hs-header">
                <img src="<?php echo e(asset('images/Logo-Polibatam.png')); ?>" alt="Logo Polibatam" class="hs-logo">
        ...
        <div class="hs-image"
             style="background-image: url('<?php echo e(asset('images/default-campus.jpg')); ?>');"
             data-aos="fade-left">
        </div>
    </section>
...
<?php /**PATH C:\Users\LENOVO T14\Documents\SistemPengolahanKRS-KHS\resources\views/landing.blade.php ENDPATH**/ ?>