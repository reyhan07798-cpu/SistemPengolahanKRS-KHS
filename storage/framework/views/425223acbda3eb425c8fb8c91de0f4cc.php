                ...
                <select name="semester_id" id="selectSemester" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $allSem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($sem->id); ?>" <?php echo e($filterSemesterId == $sem->id ? 'selected' : ''); ?>>
                            <?php echo e($sem->semester); ?> <?php echo e($sem->tahun_ajaran); ?> <?php if($sem->is_active): ?> ★ Aktif <?php endif; ?>
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div>
                ...
                <select name="kode_mk" id="selectMK" onchange="onMKChange(this)">
                    ...
                    <?php $__currentLoopData = $mataKuliahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($mk['kode']); ?>" <?php echo e($filterKodeMK == $mk['kode'] ? 'selected' : ''); ?>>
...
<script>
const KODE_MK = '<?php echo e($filterKodeMK ?? ""); ?>';
const KELAS   = '<?php echo e($filterKelas ?? ""); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dosen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO T14\Documents\SistemPengolahanKRS-KHS\resources\views/pages/dosen_matkul/input-nilai.blade.php ENDPATH**/ ?>