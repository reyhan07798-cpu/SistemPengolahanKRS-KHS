...
@section('content')
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-6">
        ...
        <form method="GET" action="/dosen/wali/krs-verifikasi">
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                ...
                                <!-- Tombol Setujui -->
                                {{-- ✅ Route diperbaiki dengan prefix dosen_wali --}}
                                <form action="/dosen/wali/krs/{{ $krs['nim'] }}/approve" method="POST" class="inline">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <!-- Tombol Tolak -->
                                {{-- ✅ Route diperbaiki dengan prefix dosen_wali --}}
                                <form action="/dosen/wali/krs/{{ $krs['nim'] }}/reject" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
