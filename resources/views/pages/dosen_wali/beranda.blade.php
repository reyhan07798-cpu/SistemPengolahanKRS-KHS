...
@section('content')
    <div class="container mx-auto max-w-7xl">
        ...
        <header class="mb-8">
            ...
            <p class="text-sm text-gray-500">Selamat datang, {{ session('user_name', 'Dosen') }}</p>
        </header>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
