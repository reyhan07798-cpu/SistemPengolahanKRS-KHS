                ...
                <div class="nb-modal-body">
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="text" name="nama_paket" value="{{ old('nama_paket') }}" placeholder="Paket Normal Semester 3" required>
                        </div>
                            ...
                            <div class="nb-bordered-list max-h-60 overflow-y-auto space-y-1">
                                @foreach($allMataKuliah as $mk)
                                    <label class="flex items-center gap-3 cursor-pointer hover:bg-accent-soft p-2 rounded-md transition-colors">
                                        <input type="checkbox" name="mata_kuliah[]" value="{{ $mk->id }}" data-sks="{{ $mk->sks }}" class="nb-no-style w-5 h-5 cursor-pointer mk-checkbox" style="accent-color: var(--color-accent);">
                                        <div class="flex-1 min-w-0">
                                            <span class="text-sm font-bold text-ink">{{ $mk->nama }}</span>
                                            <span class="text-xs text-muted ml-2">({{ $mk->sks }} SKS)</span>
                                        </div>
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="2" placeholder="Deskripsi singkat paket...">{{ old('deskripsi') }}</textarea>
                        </div>
                    </div>
                </div>
