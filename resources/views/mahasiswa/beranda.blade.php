...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-dark mt-2">{{ $data['semester_aktif'] }}</h2>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Total SKS</p>
                    <h2 class="text-3xl font-bold text-gray-400 mt-2">{{ $data['total_sks'] }}</h2>
                </div>
                <div class="p-2 bg-gray-100 rounded-lg text-gray-500">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">IPK</p>
                    <h2 class="text-3xl font-bold text-dark mt-2">{{ number_format($data['ipk'], 2) }}</h2>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <div class="flex justify-between items-start">
                <div>
                    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Mata Kuliah Lulus</p>
                    <h2 class="text-3xl font-bold text-dark mt-2">{{ $data['mata_kuliah_lulus'] }}</h2>
                </div>
