...
<head>
  ...
  <style>
    ...
    @media (max-width: 1023px) {
      main {
        background-image: linear-gradient(rgba(6,11,22,0.9), rgba(6,11,22,0.7)), url('{{ asset('images/default-campus.jpg') }}');
...
<body class="font-sans antialiased" style="font-family: 'Plus Jakarta Sans', sans-serif;">
  ...
  <main class="relative min-h-screen lg:grid lg:grid-cols-2">
    ...
    <div class="hidden lg:flex relative h-full flex-col p-10 overflow-hidden border-r-[4px] border-[var(--color-ink)] bg-gradient-to-br from-slate-900 via-navy-900 to-slate-950">
      <div class="absolute inset-0 z-0 opacity-30 bg-cover bg-center" style="background-image: url('{{ asset('images/default-campus.jpg') }}');"></div>
          ...
          <div class="space-y-1.5">
            ...
            <div class="relative">
              ...
              <input
                ...
                autocomplete="off"
                class="nb-input !pl-11 w-full @error('identifier') !border-red-400 @enderror"
              >
            </div>
            @error('identifier')
          ...
          <div class="space-y-1.5">
            ...
            <div class="relative">
              ...
              <input
                ...
                autocomplete="off"
                class="nb-input !pl-11 !pr-11 w-full @error('password') !border-red-400 @enderror"
              >
