        ...
        <aside class="nb-sidebar" id="nbSidebar">
            <div class="nb-sidebar-brand">
                <div
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="Logo SIPAKAR" class="w-full h-full object-contain"
            ...
            <nav class="nb-sidebar-nav">
                ...
                <div class="nb-nav-group {{ $isWaliActive ? 'open' : '' }}" id="navGroupWali">
                    ...
                    <div class="nb-nav-submenu">
                        @if($hasWaliRole)
                            <a href="{{ route('dosen.wali.beranda') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.wali.beranda') ? 'active' : '' }}">
                                <span class="material-symbols-outlined">home</span>
                                <span>Beranda</span>
                            </a>
                            <a href="{{ route('dosen.wali.krs-verifikasi') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.wali.krs-verifikasi') ? 'active' : '' }}">
                                <span class="material-symbols-outlined">fact_check</span>
                                <span>Verifikasi KRS</span>
                            </a>
                            <a href="{{ route('dosen.wali.khs') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.wali.khs') ? 'active' : '' }}">
                ...
                <div class="nb-nav-group {{ $isMatkulActive ? 'open' : '' }}" id="navGroupMatkul">
                    ...
                    <div class="nb-nav-submenu">
                        @if($hasMatkulRole)
                            <a href="{{ route('dosen.mk.beranda') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.mk.beranda') ? 'active' : '' }}">
                                <span class="material-symbols-outlined">home</span>
                                <span>Beranda</span>
                            </a>
                            <a href="{{ route('dosen.mk.input-nilai') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.mk.input-nilai') ? 'active' : '' }}">
                                <span class="material-symbols-outlined">edit_note</span>
                                <span>Input Nilai</span>
                            </a>
                            <a href="{{ route('dosen.mk.lihat-nilai') }}"
                                class="nb-nav-sub-item {{ request()->routeIs('dosen.mk.lihat-nilai') ? 'active' : '' }}">
                ...
                <div style="border-top: 1px solid rgba(255,255,255,0.1); margin-top: 8px; padding-top: 8px;">
                    <a href="{{ route('dosen.profil') }}"
                        class="nb-nav-item {{ request()->routeIs('dosen.profil') ? 'active' : '' }}"
                    ...
                    <div class="min-w-0">
                        ...
                        @else
                            <div class="nb-breadcrumb">
                                <a
                                    href="{{ session('is_dosen_wali') ? route('dosen.wali.beranda') : route('dosen.mk.beranda') }}">Dosen</a>
                                <span class="sep">/</span>
