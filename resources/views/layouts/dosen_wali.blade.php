        ...
        <div class="flex-1">
            ...
            <nav class="p-4">
                ...
                <a href="{{ route('dosen_wali.krs.verifikasi') }}"
                    class="sidebar-link {{ request()->routeIs('dosen_wali.krs.verifikasi') ? 'active' : '' }}"> <svg
                ...
                <a href="{{ route('dosen_wali.khs') }}"
                    class="sidebar-link {{ request()->routeIs('dosen_wali.khs') ? 'active' : '' }}"> <svg fill="none"
                ...
                <a href="{{ route('dosen_wali.profil') }}"
                    class="sidebar-link {{ request()->routeIs('dosen_wali.profil') ? 'active' : '' }}"> <svg fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
