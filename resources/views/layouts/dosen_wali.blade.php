...
<body class="h-screen flex overflow-hidden">
    ...
    <aside class="w-64 bg-dark flex flex-col hidden md:flex">
        <div class="flex-1">
            ...
            <!-- Navigation -->
            <nav class="p-4">
                <a href="{{ route('pages.dosen_wali.beranda') }}"
                    class="sidebar-link {{ request()->routeIs('pages.dosen_wali.beranda') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 ２H6a２ ２ 0 01-２-２v-２zM14 16a２ ２ 0 01２-２h２a２ ２ 0 01２ ２v２a２ ２ 0 01-２ ２h-２a２ ２ 0 01-２-２v-２z">
                        </path>
                    </svg>
                    Beranda
                </a>
                <a href="{{ route('pages.dosen_wali.krs.verifikasi') }}"
                    class="sidebar-link {{ request()->routeIs('pages.dosen_wali.krs.verifikasi') ? 'active' : '' }}"> <svg
                ...
                <a href="{{ route('pages.dosen_wali.khs') }}"
                    class="sidebar-link {{ request()->routeIs('pages.dosen_wali.khs') ? 'active' : '' }}"> <svg fill="none"
                ...
                <a href="{{ route('pages.dosen_wali.profil') }}"
                    class="sidebar-link {{ request()->routeIs('pages.dosen_wali.profil') ? 'active' : '' }}"> <svg fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
